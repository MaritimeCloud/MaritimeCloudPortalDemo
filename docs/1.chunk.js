...
var DeviceNewComponent = (function () {
    ...
    DeviceNewComponent.prototype.generateForm = function () {
        ...
        formControlModel = { formGroup: this.registerForm, elementId: 'deviceId', inputType: 'text', labelName: 'Device ID', placeholder: 'Enter Device ID to generate MRN', validator: forms_1.Validators.required, pattern: this.mrnPattern, errorText: this.mrnPatternError };
...
var UserDetailsComponent = (function () {
    function UserDetailsComponent(route, usersService, notifications) {
        this.route = route;
