...
var InstanceDetailsComponent = (function () {
    function InstanceDetailsComponent(servicesService, authService, route, router, viewModelService, navigationHelperService, instancesService, notifications, designsService, fileHelperService, mrnHelper) {
        this.servicesService = servicesService;
        this.authService = authService;
        this.route = route;
        this.router = router;
    ...
    InstanceDetailsComponent.prototype.shouldDisplayDelete = function () {
        return this.isAdmin();
    };
